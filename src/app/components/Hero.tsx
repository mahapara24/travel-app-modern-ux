...
const Hero = () => {
  return (
    <section className="max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row border-2 border-red-700 ">
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        ...
        />
        <h1 className="bold-52 lg:bold-88">Pedro Travel Camp Area</h1>
